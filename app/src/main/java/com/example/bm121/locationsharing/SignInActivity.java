...
public class SignInActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onStart() {
        super.onStart();
        // Check auth on Activity start to skip sign in
    ...
    private void signIn() {
        ...
        showProgressDialog();
        String email = mEmailField.getText().toString(); //get email
        String password = mPasswordField.getText().toString(); //get password
    ...
    private boolean validateForm() {
        ...
        if (TextUtils.isEmpty(mEmailField.getText().toString())) {
            ...
            if (!mEmailField.getText().toString().contains("@") || !mEmailField.getText().toString().contains(".")){
                mEmailField.setError("Must be a valid e-mail");
                result = false;
            }
            else{
